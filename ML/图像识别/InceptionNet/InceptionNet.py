...
def InceptionNet(input_shape=(3, 32, 32), classes=num_classes):
    ...
    X = X_input
    X = Conv2D(filters=16, kernel_size=3, strides=1, padding='same', kernel_regularizer=l2(
        1e-4), kernel_initializer='he_normal')(X)  # 64, 32, 32
...
checkpoint = ModelCheckpoint(filepath='./cifar10_InceptionNet.h5',
